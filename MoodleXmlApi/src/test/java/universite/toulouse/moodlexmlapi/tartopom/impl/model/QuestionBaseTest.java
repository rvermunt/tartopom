...
public class QuestionBaseTest {
    ...
    public void setUp() throws Exception {
        ...
        qb = new QuestionBase(Float.valueOf("5.0"), null,
                new EnclosedText("feedback"), "base64", "imageUrl",
                new EnclosedText("name"), Float.valueOf("10.0"),
                qt, QuestionType.calculated,
                false);
    }
    ...
    public void testSetQuestionText() {
        QuestionTextAdaptated text = new QuestionTextAdaptated();
